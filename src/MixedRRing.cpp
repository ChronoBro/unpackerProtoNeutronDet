...
int main()
{
  ...
  ofstream fout("cal/rRingN.cal");
  ofstream fwhm("cal/fwhmrRing.dat");
  TFile f("sort.root");
  TCanvas* canvas[1];
  int Ntele = 1;
  int Nstrip = 32;
  ostringstream outstring;
  TH2I frame("frame","",10,2.8,6.5,10,0,800);
      ...
      for (int istrip =0;istrip<Nstrip;istrip++)
        {
          ...
          outstring.str("");
          outstring << "rus/RringsC/RusRingC"<<"_"<<istrip;
