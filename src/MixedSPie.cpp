...
int main()
{
  ...
  ofstream fout("cal/sPieN.cal");
  ofstream fwhm("cal/fwhmsPie.dat");
  TFile f("sort.root");
  TCanvas* canvas[1];
  int Ntele = 1;
  int Nstrip = 16;
      ...
      for (int istrip =0;istrip<Nstrip;istrip++)
        {
          ...
          outstring.str("");
          outstring << "S2/S2piesC/S2PieC"<<"_"<<istrip;
  ...
  TFile g("root/MixedSPie.root","RECREATE");
