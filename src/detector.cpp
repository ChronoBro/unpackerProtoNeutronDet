...
detector::detector(TRandom * ran0, histo * Histo0)
{
  Histo = Histo0;
  ran = ran0;
...
//*************************************************************
bool detector::unpack(unsigned short *&point,int runno)
{
  bool stat = true;
...
//*************************************************************
bool detector::unpackCsi(unsigned short *&point,int runno)
{
  NE = 0;
  CsIM =0;
...
bool detector::unpackSi_HINP4(unsigned short *&point)
{
