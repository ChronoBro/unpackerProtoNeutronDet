...
int main()
{
  ...
  ofstream fout("cal/rPieN.cal");
  ofstream fwhm("cal/fwhmrPie.dat");
  TFile f("sort.root");
  TCanvas* canvas[1];
  int Ntele = 1;
  int Nstrip = 64;
      ...
      for (int istrip =0;istrip<Nstrip;istrip++)
        {
          ...
          outstring.str("");
          outstring << "rus/RpiesC/RusPieC"<<"_"<<istrip;
  ...
  TFile g("root/MixedRPie.root","RECREATE");
